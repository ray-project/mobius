...
public class DualStateBackendManager<V> extends AbstractStateBackendManager<V> {

  private static final Logger LOG = LoggerFactory.getLogger(DualStateBackendManager.class);

  public DualStateBackendManager(KeyValueStore<String, Map<Long, byte[]>> backStore) {
    super(backStore);
  }
