...
/**
 * Used for setup in-cache state.
 * NOTE: This config is nothing to do with the Memory Backend.
 */
...
//  String STATE_MEMORY_ROCKSDB_HIGH_PRIORITY_POOL_RATIO = "state.buffer.rocksdb.high-priority-pool.ratio";
