...
public abstract class TypeSerializer<T> implements Serializable {
   ...
   *
   * <p>Because this serializer might be used in several threads. In order to ensure thread safety,
   * we need to use this method to use an independent serializer in each thread.
   */
