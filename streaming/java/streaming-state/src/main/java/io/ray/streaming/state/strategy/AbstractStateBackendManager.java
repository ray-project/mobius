...
import io.ray.streaming.state.backend.BackendTransactional;
 ...
 */
public abstract class AbstractStateBackendManager<V> implements BackendTransactional {
  ...
  public AbstractStateBackendManager(KeyValueStore<String, Map<Long, byte[]>> backStore) {
    kvStore = backStore;
  }
