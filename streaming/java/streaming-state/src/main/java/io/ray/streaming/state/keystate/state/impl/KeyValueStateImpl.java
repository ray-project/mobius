...
public class KeyValueStateImpl<K, V> implements KeyValueState<K, V> {

  private final StateHelper<Map<K, V>> helper;

  public KeyValueStateImpl(KeyValueStateDescriptor<K, V> descriptor, KeyStateBackend backend) {
