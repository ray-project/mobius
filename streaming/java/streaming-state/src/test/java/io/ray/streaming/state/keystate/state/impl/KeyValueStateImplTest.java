...
public class KeyValueStateImplTest {

  KeyValueStateImpl<Integer, String> mapState;
  ...
  public void setUp() throws Exception {
    ...
    KeyValueStateDescriptor<Integer, String> descriptor =
        KeyValueStateDescriptor.build("KeyValueStateImplTest", Integer.class, String.class);
    descriptor.setTableName("table");
    mapState = (KeyValueStateImpl<Integer, String>) keyStateBackend.getMapState(descriptor);
  }
