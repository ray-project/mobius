...
class JobWorker(object):
    ...
    def __clear_expired_cp_state(self, checkpoint_id: int):
    ...
    def _gen_unique_key(self, key_prefix):
        return (key_prefix + str(self.config.get(Config.STREAMING_JOB_NAME)) +
